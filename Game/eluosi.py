...
canvas.focus_set() # 聚焦到canvas画板对象上
canvas.bind("<KeyPress-a>", horizontal_move_block)
canvas.bind("<KeyPress-d>", horizontal_move_block)
canvas.bind("<KeyPress-w>", rotate_block)
canvas.bind("<KeyPress-s>", land)
